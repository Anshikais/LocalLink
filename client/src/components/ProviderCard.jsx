...
export default function ProviderCard({ provider }) {
  ...
  return (
    <div className="group bg-white rounded-2xl border border-slate-200/90 hover:border-emerald-300 shadow-xs hover:shadow-md transition-all duration-200 overflow-hidden flex flex-col justify-between">
      
      <div>
        {/* Header Cover Image */}
        <div className="relative h-44 overflow-hidden bg-slate-100">
          <img
            src={provider.coverImage || 'https://images.unsplash.com/photo-1621905251189-08b45d6a269e?auto=format&fit=crop&q=80&w=800'}
          ...
          {/* Featured Badge */}
          {provider.isFeatured && (
            <span className="absolute top-3 left-3 bg-emerald-600 text-white font-extrabold text-[10px] uppercase tracking-wider px-2.5 py-0.5 rounded-md shadow-xs flex items-center gap-1">
          ...
          <div className="absolute bottom-3 left-3 right-3 flex items-end gap-3">
            <div className="relative shrink-0">
              ...
              {provider.verificationStatus === 'approved' && (
                <div className="absolute -bottom-1 -right-1 bg-emerald-600 text-white p-0.5 rounded-full ring-2 ring-white" title="Verified Provider">
            ...
            <div className="text-white min-w-0 flex-1 drop-shadow-xs">
              ...
              <p className="text-xs text-emerald-200 font-semibold truncate mt-0.5">
          ...
          <div className="flex items-center justify-between gap-2 text-xs pt-0.5">
            ...
            {provider.isAvailable ? (
              <span className="inline-flex items-center gap-1 text-[10px] font-extrabold uppercase tracking-wider text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded-md border border-emerald-200">
                <Clock className="w-3 h-3 text-emerald-600" /> Available Today
              </span>
            ) : (
        ...
        <div className="flex items-center justify-between pt-3 border-t border-slate-100">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              ...
              className="text-xs font-bold px-3.5 py-2 text-white bg-emerald-600 hover:bg-emerald-700 rounded-xl transition-all shadow-xs flex items-center gap-1"
            >
