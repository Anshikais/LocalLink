    ...
    <>
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full bg-slate-50 border border-slate-200 px-3 py-2 rounded-xl text-xs font-semibold text-slate-700 focus:bg-white focus:outline-none"
        >
      ...
      <div className="space-y-2">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full bg-slate-50 border border-slate-200 pl-7 pr-3 py-2 rounded-xl text-xs font-semibold text-slate-800 focus:bg-white focus:outline-none"
          />
        </div>
      </div>
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-3 pt-2">
          ...
          <div className="md:col-span-5 flex items-center gap-2">
            ...
            <button
              ...
              className="md:hidden flex items-center justify-center gap-1.5 px-3 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-xs font-extrabold text-slate-800 hover:bg-slate-100 transition-colors shadow-xs shrink-0"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
        ...
        <aside className="hidden md:block md:col-span-1 bg-white p-6 rounded-2xl border border-slate-200/90 shadow-xs space-y-6 md:sticky md:top-20">
      ...
      {isMobileFilterOpen && (
        <div className="fixed inset-0 z-50 md:hidden flex flex-col justify-end">
          ...
          {/* Bottom Sheet Drawer */}
          <div className="relative bg-white rounded-t-3xl border-t border-slate-200 shadow-2xl p-6 space-y-5 max-h-[85vh] flex flex-col z-10">
            ...
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 shrink-0">
              <h3 className="font-extrabold text-base text-slate-900 flex items-center gap-2">
                <SlidersHorizontal className="w-4.5 h-4.5 text-primary-600" /> Filters
              </h3>
            ...
            <div className="pt-3 border-t border-slate-100 shrink-0">
              <button
                onClick={() => setIsMobileFilterOpen(false)}
                className="w-full py-3 bg-primary-600 hover:bg-primary-700 text-white font-extrabold text-xs rounded-xl shadow-xs transition-colors flex items-center justify-center gap-2"
              >
                Show Results ({providers.length})
              </button>
            </div>
          </div>
        </div>
